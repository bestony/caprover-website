...
```
详细信息请参阅[这里](https://eff-certbot.readthedocs.io/en/stable/using.html#dns-plugins)
...
首先（至少对于 ZeroSSL，你需要获取 EAB 凭据，地址在[这里](https://app.zerossl.com/developer)），我们添加电子邮件地址，并告知 Certbot 接受该服务的 TOS：
```
